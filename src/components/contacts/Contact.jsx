    ...
    return ( 
                ...
                <div className="col-11 col-sm-9 col-md-5 d-flex flex-column flex-lg-row  align-items-center justify-content-around rounded-3 p-4 g-4" style={{background:MYBLUE}} >
                    ...
                    <div className="row col-12 col-lg-4  " >
                        <img src={photo} alt="تصویر شخص" className="d-block img-fluid w-100 h-100 p-0" style={{border:`1px solid ${BACKGROUND}`}} />
                    </div>
                    ...
                    <div className="row col-12 col-lg-1  flex-lg-column  aligin-items-center justify-content-center"  >
                        ...
                        <Link to={`/contacts/${id}`} className="btn m-1 px-3 d-inline-flex align-items-center justify-content-center w-25 " style={{background:ORANGE}}><i className="fas eye" style={{color:BACKGROUND, fontSize:20}}></i></Link>    
